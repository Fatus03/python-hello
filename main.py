...
# 🧠 Khởi tạo bot (chỉ cần default intents vì chỉ dùng slash command)
...
# 🧩 Lệnh chạy code Python đơn giản
@bot.tree.command(name="run", description="Chạy code Python đơn giản trên Discord")
